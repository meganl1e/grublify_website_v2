        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold" style={{ color: '#37474f' }}>
                Healthy, Fresh Dog Food <span style={{ color: '#6fceb7' }}>Made Simple</span>
              </h1>
              <p className="text-lg text-muted-foreground">
                Premium nutrition packs tailored to your dog's needs. Made with fresh, human-grade ingredients.
              </p>
              <Link href="/waitlist">
                <Button className="text-lg px-8 py-6" style={{ backgroundColor: '#6fceb7' }}>
                  Join Waitlist
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#37474f' }}>
              Why Choose Grublify?
            </h2>
            <p className="text-lg text-muted-foreground">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                ...
                />
                <h3 className="text-xl font-semibold mb-2" style={{ color: '#37474f' }}>
                  {feature.title}
                </h3>
